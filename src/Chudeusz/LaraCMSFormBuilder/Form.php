...
namespace Chudeusz\LaraCMSFormBuilder;
...
use Chudeusz\LaraCMSFormBuilder\Fields\FormField;
...
class Form
{
    ...
    public function rebuildForm()
    {
        ...
        if (get_class($this) === 'Chudeusz\LaraCMSFormBuilder\Form') {
     ...
     *
     * @return \Chudeusz\LaraCMSFormBuilder\Form
     */
