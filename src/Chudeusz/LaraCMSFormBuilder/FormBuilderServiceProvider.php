...
class FormBuilderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('Chudeusz\LaraCMSFormBuilder\Console\FormMakeCommand');
        ...
        $this->app->alias('laravel-form-builder', 'Chudeusz\LaraCMSFormBuilder\FormBuilder');
    ...
    protected function registerFormHelper()
    {
        ...
        $this->app->alias('laravel-form-helper', 'Chudeusz\LaraCMSFormBuilder\FormHelper');
    }
