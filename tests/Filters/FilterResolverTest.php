...
use \Chudeusz\LaraCMSFormBuilder\Filters\Collection\Trim;
...
class FilterResolverTest extends FormBuilderTestCase
{
    ...
    {
        $expected = \Chudeusz\LaraCMSFormBuilder\Filters\FilterInterface::class;
    ...
    /**
     * @test
     * @expectedException \Chudeusz\LaraCMSFormBuilder\Filters\Exception\InvalidInstanceException
     */
    ...
    /**
     * @test
     * @expectedException \Chudeusz\LaraCMSFormBuilder\Filters\Exception\UnableToResolveFilterException
     */
