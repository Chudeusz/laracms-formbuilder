...
namespace {
    ...
    use Chudeusz\LaraCMSFormBuilder\Fields\ChoiceType;
    use Chudeusz\LaraCMSFormBuilder\Fields\CollectionType;
    use Chudeusz\LaraCMSFormBuilder\Fields\SelectType;
    ...
    class CollectionTypeTest extends FormBuilderTestCase
    {
        ...
        public function it_creates_collection()
        {
            ...
            $this->assertInstanceOf('Chudeusz\LaraCMSFormBuilder\Fields\SelectType', $emailsCollection->prototype());
        }
