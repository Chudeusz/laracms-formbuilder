...
use Chudeusz\LaraCMSFormBuilder\Fields\RepeatedType;
...
class RepeatedTypeTest extends FormBuilderTestCase
{
    ...
    public function it_creates_repeated_as_two_inputs()
    {
        ...
        $this->assertInstanceOf('Chudeusz\LaraCMSFormBuilder\Fields\InputType', $repeated->first);
        $this->assertInstanceOf('Chudeusz\LaraCMSFormBuilder\Fields\InputType', $repeated->second);
