...
use Chudeusz\LaraCMSFormBuilder\Events\AfterFormValidation;
use Chudeusz\LaraCMSFormBuilder\Events\BeforeFormValidation;
use Chudeusz\LaraCMSFormBuilder\Fields\InputType;
...
class FormTest extends FormBuilderTestCase
{
    ...
    public function it_adds_fields()
    {
        ...
        $this->assertInstanceOf(
            'Chudeusz\LaraCMSFormBuilder\Fields\InputType',
            $this->plainForm->getField('name')
        );

        $this->assertInstanceOf(
            'Chudeusz\LaraCMSFormBuilder\Fields\TextareaType',
            $this->plainForm->getField('description')
        );

        $this->assertInstanceOf(
            'Chudeusz\LaraCMSFormBuilder\Fields\CheckableType',
            $this->plainForm->getField('remember')
        );

        $this->assertInstanceOf(
            'Chudeusz\LaraCMSFormBuilder\Fields\StaticType',
    ...
    public function it_can_add_child_form_as_field()
    {
        ...
        $this->assertInstanceOf(
            'Chudeusz\LaraCMSFormBuilder\Form',
            $form->song->getForm()
        );
    ...
    public function it_receives_validation_events()
    {
        ...
        $this->assertEquals(
            [
                'Chudeusz\LaraCMSFormBuilder\Events\BeforeFormValidation',
                'Chudeusz\LaraCMSFormBuilder\Events\AfterFormValidation',
            ],
            $events
        );
    }
    ...
    public function it_returns_binded_field_filters()
    {
        ...
        $expected = [
            'test_field' => [
                'Trim'    => new \Chudeusz\LaraCMSFormBuilder\Filters\Collection\Trim(),
                'Uppercase' => new \Chudeusz\LaraCMSFormBuilder\Filters\Collection\Uppercase()
            ],
            'test_field2' => [
                'Uppercase' => new \Chudeusz\LaraCMSFormBuilder\Filters\Collection\Uppercase()
            ]
